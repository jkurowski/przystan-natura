...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        View::share('obligation', RodoSettings::find(1));
        ...
        View::share('developro_modules', DeveloproModule::where('active', 1)->get());
        View::share('sales_points', InvestmentSalePoint::orderBy('position', 'ASC')->get());
