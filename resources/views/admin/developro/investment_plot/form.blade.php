...
@section('content')
    @if(Route::is('admin.developro.investment.plots.edit'))
        <form method="POST" action="{{route('admin.developro.investment.plots.update', [$investment, $entry])}}" enctype="multipart/form-data" class="mappa">
            {{method_field('PUT')}}
            @else
                <form method="POST" action="{{route('admin.developro.investment.plots.store', $investment)}}" enctype="multipart/form-data" class="mappa">
                    @endif
                    @csrf
                    <div class="container">
                        <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 mb-4">
                                                @include('form-elements.html-select', ['label' => 'Typ', 'name' => 'type', 'selected' => $entry->type, 'select' => [
                                                    '8' => 'Działka budowlana',
                                                    '9' => 'Działka rekreacyjna',
                                                    '10' => 'Działka inwestycyjna',
                                                    '11' => 'Grunt rolny',
                                                    '12' => 'Grunt leśny',
                                                    '13' => 'Grunt przemysłowy',
                                                    '14' => 'Grunt usługowy',
                                                    ]
                                                ])
                                            </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-4 mb-4">
                                                @include('form-elements.html-input-text', [
                                                    'label' => 'Numer działki w geoportal360.pl',
                                                    'sublabel'=> '',
                                                    'name' => 'geoportal_id',
                                                    'value' => $entry->geoportal_id
                                                ])
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row w-100 form-group">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                @include('form-elements.input-text', ['label' => 'Powierzchnia', 'sublabel'=> 'Realna powierzchnia', 'name' => 'area', 'value' => $entry->area, 'required' => 1])
                                            </div>
                                            <div class="col-3">
                                                @include('form-elements.input-text', ['label' => 'Powierzchnia (szukana)', 'sublabel'=> 'Wartość użyta w wyszukiwarkach', 'name' => 'area_search', 'value' => $entry->area_search, 'required' => 1])
                                            </div>
                                        </div>
                                    </div>
                                </div>
