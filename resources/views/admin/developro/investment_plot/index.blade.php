                            ...
                            <tr id="recordsArray_{{ $p->id }}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{route('admin.developro.investment.plots.edit', [$investment, $p])}}" class="btn action-button me-1" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Edytuj działkę"><i class="fe-edit"></i></a>
                                        <form method="POST" action="{{route('admin.developro.investment.plots.destroy', [$investment, $p])}}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            <button type="submit" class="btn action-button confirm" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Usuń działkę" data-id="{{ $p->id }}"><i class="fe-trash-2"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="{{route('admin.developro.investment.plots.create', $investment)}}" class="btn btn-primary">Dodaj działkę</a>
                </div>
            </div>
        </div>
    </div>
