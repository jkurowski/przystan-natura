        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="{{route('admin.developro.vox.index', $investment)}}?type=import" class="btn btn-primary">Synchronizuj z VOX</a>
                </div>
            </div>
        </div>
    </div>
