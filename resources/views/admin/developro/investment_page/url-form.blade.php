...
@section('content')
    @if(Route::is('admin.developro.investment.url.edit'))
        <form method="POST" action="{{route('admin.developro.investment.url.update', [$investment, $entry])}}">
            @method('PUT')
            @else
                <form method="POST" action="{{route('admin.developro.investment.url.store', $investment)}}">
                    @endif
                    @csrf
                    <div class="container">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body control-col12">
                                ...
                                <div class="row w-100 form-group">
                                    @include('form-elements.html-select', ['label' => 'Okno docelowe', 'name' => 'url_target', 'selected' => $entry->url_target, 'select' => ['_self' => 'Ta samo okno', '_blank' => 'Nowe okno', '_domain' => 'Link w domenie inwestycji']])
                                </div>
                                <div class="row w-100 form-group">
