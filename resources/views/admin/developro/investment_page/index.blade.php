                ...
                <div class="table-overflow">
                    <table id="sortable" class="table data-table mb-0 w-100">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Url: cel</th>
                        ...
                        @foreach ($list as $item)
                            <tr id="recordsArray_{{ $item->id }}">
                                ...
                                <td class="text-center">{{ $item->url_target }}</td>
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        ...
                                        @if(!$item->lock)
                                            ...
                                            @else
                                                <a href="{{route('admin.developro.investment.url.edit', [$investment, $item->id])}}" class="btn action-button me-1" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Edytuj wpis"><i class="fe-edit"></i></a>
                                            @endif
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="{{route('admin.developro.investment.url.create', $investment)}}" class="btn btn-primary me-1">Dodaj link</a>
