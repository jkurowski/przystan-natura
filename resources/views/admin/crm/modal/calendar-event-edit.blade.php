                                    ...
                                    <div class="col-9">
                                        ...
                                        <div id="selectedClientItem">
                                            @if($event->client_id != 0)
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h4>{{ $event->client->name }} <button type="button" id="btn-confirm" class="btn btn-primary btn-sm action-button"><i class="las la-trash-alt"></i></button></h4>
                                                        @if($event->client->mail)<span>E: {{$event->client->mail}}</span>@endif
                                                        @if($event->client->phone)<span>T: {{$event->client->phone}}</span>@endif
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
