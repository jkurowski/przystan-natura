            ...
            <div class="container">
                <div class="row flex-wrap flex-xl-nowrap">
                    ...
                    <div class="col-12 col-xl-6 vw-50 pe-3 pe-xl-0 mt-4 mt-sm-5 mt-xl-0">
                        <img src="{{ asset('images/family-house.jpg') }}" alt="Rodzina spędzająca czas w ogrodzie przy nowoczesnym domu w Przystani Natura" class="w-100" width="1160" height="787" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <x-section-header title="Naturalna <i>wygoda</i>" subtitle="UDOGODNIENIA" class="ps-0 ps-lg-5 pe-0">
                            <ul id="twocolums" class="mb-0 list-unstyled">
                                ...
                                <li><img src="{{ asset('/images/icons/tile.svg') }}" alt="" aria-hidden="true" width="87" height="87" loading="lazy" decoding="async"> Drogi dojazdowe <br>z kostki</li>
                                <li><img src="{{ asset('/images/icons/gate.svg') }}" alt="" aria-hidden="true" width="87" height="87" loading="lazy" decoding="async"> 2 bramy <br>wjazdowe</li>
                            </ul>
                        </x-section-header>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row flex-wrap flex-xl-nowrap flex-row-reverse">
                    ...
                    <div class="col-12 col-xl-7 vw-50 p-0 d-flex align-items-start">
                        <img src="{{ asset('images/mapa-odleglosci.jpg') }}" alt="Mapa dojazdu do inwestycji Przystań Natura" class="w-100" width="1040" height="918" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row flex-wrap flex-xl-nowrap">
                    ...
                    <div class="col-12 col-xl-6 vw-50 p-0 d-flex align-items-end">
                        <img src="{{ asset('images/location-map.jpg') }}" alt="Mapa okolicy Przystani Natura z pobliskimi udogodnieniami: stadnina koni, sklepy, plac zabaw, przedszkole i przychodnia" class="d-none d-xl-block w-100" width="1160" height="787" loading="lazy" decoding="async">
                        <img src="{{ asset('images/location-map-mobile.jpg') }}" alt="Mapa okolicy Przystani Natura z pobliskimi udogodnieniami: stadnina koni, sklepy, plac zabaw, przedszkole i przychodnia" class="d-block d-xl-none w-100" width="960" height="661" loading="lazy" decoding="async">
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="house-model-item">
                                <div class="house-model-thumb position-relative">
                                    <div class="card-shape">
                                        <img src="{{ asset('/images/dom-70.jpg') }}" alt="Wnętrze domu 70 m² z kuchnią i jadalnią w Przystani Natura" class="w-100" width="467" height="359" loading="lazy" decoding="async">
                                    </div>
                                    <div class="circle">
                                        <svg class="icon" viewBox="0 0 26 26">
                                            <path d="M17.3375 10.1985L8.01328 19.5228L6.48145 17.9909L15.8046 8.66667H7.58753V6.5H19.5042V18.4167H17.3375V10.1985Z" fill="currentColor"/>
                    ...
                    <div class="col-12 col-lg-4">
                        <a href="{{ route('front.developro.plan') }}">
                            <div class="house-model-item">
                                <div class="house-model-thumb position-relative">
                                    <div class="card-shape">
                                        <img src="{{ asset('/images/dom-90.jpg') }}" alt="Nowoczesne wnętrze domu 90 m² z otwartą strefą dzienną" class="w-100" width="467" height="359" loading="lazy" decoding="async">
                                    </div>
                                    <div class="circle">
                                        <svg class="icon" viewBox="0 0 26 26">
                                            <path d="M17.3375 10.1985L8.01328 19.5228L6.48145 17.9909L15.8046 8.66667H7.58753V6.5H19.5042V18.4167H17.3375V10.1985Z" fill="currentColor"/>
                    ...
                    <div class="col-12 col-lg-4">
                        <a href="{{ route('front.developro.plan') }}">
                            <div class="house-model-item">
                                <div class="house-model-thumb position-relative">
                                    <div class="card-shape">
                                        <img src="{{ asset('/images/dom-12.jpg') }}" alt="Salon w domu 120 m² z dużymi przeszkleniami w Przystani Natura" class="w-100" width="467" height="359" loading="lazy" decoding="async">
                                    </div>
                                    <div class="circle">
                                        <svg class="icon" viewBox="0 0 26 26">
                                            <path d="M17.3375 10.1985L8.01328 19.5228L6.48145 17.9909L15.8046 8.66667H7.58753V6.5H19.5042V18.4167H17.3375V10.1985Z" fill="currentColor"/>
        ...
        <section id="mainGallery" class="pt-0">
            ...
            <div class="gallery-wrap mt-100" id="gallery">
                ...
                <div class="item active">
                    <a href="">
                        <img src="{{ asset('images/gallery-1.jpg') }}" alt="Nowoczesne domy jednorodzinne w inwestycji Przystań Natura" loading="lazy" decoding="async" width="960" height="720">
                ...
                <div class="item">
                    <a href="">
                        <img src="{{ asset('images/gallery-2.jpg') }}" alt="Nowoczesne domy jednorodzinne w inwestycji Przystań Natura" loading="lazy" decoding="async" width="960" height="720">
                        <div class="gallery-item-info">
                            <h2>Dom 90 m² + wiata garażowa</h2>
                            <span>
                        <svg class="icon" viewBox="0 0 26 26">
                ...
                <div class="item">
                    <a href="">
                        <img src="{{ asset('images/gallery-3.jpg') }}" alt="Nowoczesne domy jednorodzinne w inwestycji Przystań Natura" loading="lazy" decoding="async" width="960" height="720">
                        <div class="gallery-item-info">
                            <h2>Dom 90 m² + wiata garażowa</h2>
                            <span>
                        <svg class="icon" viewBox="0 0 26 26">
                ...
                <div class="item">
                    <a href="">
                        <img src="{{ asset('images/gallery-4.jpg') }}" alt="Nowoczesne domy jednorodzinne w inwestycji Przystań Natura" loading="lazy" decoding="async" width="960" height="720">
                        <div class="gallery-item-info">
                            <h2>Dom 90 m² + wiata garażowa</h2>
                            <span>
                        <svg class="icon" viewBox="0 0 26 26">
