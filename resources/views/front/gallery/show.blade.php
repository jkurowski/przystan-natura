@extends('layouts.page', ['body_class' => 'position-relative', 'body_id' => 'page-gallery'])

@section('meta_title', $page->title ?? 'Galeria - '.$category->name)
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <nav class="breadcrumbs">
                        ...
                        <span class="current">Galeria</span>
                    </nav>
                </div>
            </div>
        </div>
