...
@isset($page)
    @section('meta_title', $page->title.' - '.$property->name)
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <nav class="breadcrumbs">
                        ...
                        <a href="{{ route('front.developro.plan') }}">Oferta domów</a>
                        <span class="sep">
                            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.7779 4.6098L3.32777 0.159755C3.22485 0.0567475 3.08745 0 2.94095 0C2.79445 0 2.65705 0.0567475 2.55412 0.159755L2.2264 0.487394C2.01315 0.700889 2.01315 1.04788 2.2264 1.26105L5.96328 4.99793L2.22225 8.73895C2.11933 8.84196 2.0625 8.97928 2.0625 9.1257C2.0625 9.27228 2.11933 9.4096 2.22225 9.51269L2.54998 9.84025C2.65298 9.94325 2.7903 10 2.9368 10C3.0833 10 3.2207 9.94325 3.32363 9.84025L7.7779 5.38614C7.88107 5.2828 7.93774 5.14484 7.93741 4.99817C7.93774 4.85094 7.88107 4.71305 7.7779 4.6098Z" fill="#A4804D"/></svg>
                        </span>
        ...
        <div id="planNav" class="container mb-3 mb-sm-5">
            <div class="row">
                ...
                <div class="col-12 col-sm-4 mb-2 mb-sm-0">
                    <x-nav-property-link :property="$prev" label="Poprzedni" direction="prev" />
                </div>
                <div class="col-12 col-sm-4 text-center order-first order-sm-0 mb-2 mb-sm-0">
                    <a href="{{ route('front.developro.plan') }}" class="bttn bttn-active">
                        Plan inwestycji
                    </a>
                </div>
                <div class="col-12 col-sm-4 text-end">
                    <x-nav-property-link :property="$next" label="Następny" direction="next" />
                </div>
            </div>
        </div>
                        ...
                        <div class="col-12 col-lg-5 d-flex flex-column align-items-start justify-content-start">
                            ...
                            @if($property->status)
                                <div class="page-entry-karta__info-item d-flex flex-column flex-sm-row justify-content-start justify-content-sm-between align-items-center align-items-sm-end w-100">
                                    <h3>{!! roomStatusBadge($property->status) !!}</h3>
                                </div>
                            @endif
                            ...
                            @if($property->plot_area)
                                <div class="page-entry-karta__info-item d-flex flex-column flex-sm-row justify-content-start justify-content-sm-between align-items-center align-items-sm-end w-100">
                                    ...
                                    <span><b>{{ $property->plot_area }} m<sup>2</sup></b></span>
                                </div>
                            @endif
                            ...
                            @if($property->priceHistory->count() > 0 && $property->status == 1 && $investment->show_pricehistory)
                                <div>
                                    <button type="button" class="bttn bttn-sm bttn-active mt-3" data-bs-toggle="modal" data-bs-target="#priceHistoryModal">Historia ceny</button>
                                </div>
                            @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        @if($investment->file_brochure)
                                            <a href="{{ asset('investment/brochure/'.$investment->file_brochure) }}" class="bttn mt-5" target="_blank">Prospekt informacyjny</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
