            ...
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-center align-items-center">
                    ...
                    @if($investment->type == 3)
                        <a href="{{route('front.developro.plan', $investment->slug)}}" class="next-prev__link d-flex align-items-center justify-content-center gap-2">
                            Plan inwestycji
                        </a>
                    @endif
                </div>
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="row">
                            <div class="col-12 col-sm-7 d-flex flex-column align-items-start justify-content-start gap-15 scroll-anim-bottom">
                                ...
                                <div class="d-none"><a href="" class="custom-button mt-0mt-md-10">Historia ceny</a></div>

                                <div class="container-fluid p-0">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            @if($property->file_pdf)
                                                <a href="{{ asset('/investment/property/pdf/'.$property->file_pdf) }}" class="custom-button mt-0mt-md-10" target="_blank">Pobierz plan domu</a>
                                            @endif
                                        </div>
