tinymce.PluginManager.add('floor', function(editor, url) {
    var openDialog = function () {
        var win;
        win = editor.windowManager.open({
            title: 'Wstaw galerię',
            file: tinyMCE.baseURL + '/plugins/floor/dialog.php?editor=' + editor.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
            body: {
                type: 'panel',
                classes: 'myClassname',
                items: [
                    {
                        type: 'htmlpanel',
                        html: '<div id="floor" class="row pt-3 pb-3 m-0"></div>'
                    }
                ]
            },
            size: 'large',
